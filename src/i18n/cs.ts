export const cs = {
  meta: {
    ...
    description:
      'Tomáš Bruckner je softwarový inženýr, webový vývojář a konzultant. Vývoj, analýzy projektů a školení na míru.',
    ogLocale: 'cs_CZ',
  },
  ...
  hero: {
    ...
    about:
      'Softwarový inženýr, webový vývojář a konzultant. Nabízím programátorské práce, analyzování nových i existujících projektů, zavádění a optimalizace vývojových procesů i školení na míru.',
    cta: 'Napiš mi',
  },
